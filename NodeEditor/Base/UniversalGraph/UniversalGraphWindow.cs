...
namespace NodeEditor
{
    public abstract class UniversalGraphWindow : BaseGraphWindow
    {
        ...
        public string TitleName { get; set; } = "UniversalGraphWindow";
        protected virtual string TitleIcon => $"{GraphCreateAndSaveHelper.NodeGraphProcessorPathPrefix}/Editor/Icon_Dark.png";

        protected override void OnEnable()
        {
            base.OnEnable();

            titleContent = new GUIContent(TitleName, AssetDatabase.LoadAssetAtPath<Texture2D>(TitleIcon));
