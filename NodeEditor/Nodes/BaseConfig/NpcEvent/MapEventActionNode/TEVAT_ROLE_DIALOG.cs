...
{
    public class ActionRoleDialogData : ActionData
    {
        [HideReferenceObjectPicker, LabelText("对话组"), EnableIf("@false")]
        public int NpcTalkGroupID;

        public ActionRoleDialogData(NpcEventActionConfigNode baseNode)
        {
            BaseNode = baseNode;
        }
    ...
    [Serializable]
    [NodeMenuItem("剧情行为/角色对话框", typeof(NodeEditor.NpcEventEditor.NpcEventGraph))]
    public sealed partial class TEVAT_ROLE_DIALOG : NpcEventActionConfigNode
    {
        // 角色对话框
        // 参数0 : 对话组-NpcTalkGroupConfig
        public TEVAT_ROLE_DIALOG() : base(NpcEventActionConfig_TEventActionType.TEVAT_ROLE_DIALOG) 
        {
            ActionData = new ActionRoleDialogData(this);
        }

        public ActionRoleDialogData DialogData => ActionData as ActionRoleDialogData;
