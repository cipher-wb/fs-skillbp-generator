...
{
    internal sealed class MapEventGeneralFuncGroupConfigProcessor : NodeEditorBaseProcessor<MapEventGeneralFuncGroupConfig>
    {
        ...
        {
            {("外部引用", 0), new HashSet<string> { "ID", "Functions" } },
        };
