...
namespace GraphProcessor
{
    ...
    public class BaseEdgeConnectorListener : IEdgeConnectorListener
    {
        ...
        protected Dictionary< Edge, PortView >    edgeInputPorts = new Dictionary< Edge, PortView >();
        protected Dictionary< Edge, PortView >    edgeOutputPorts = new Dictionary< Edge, PortView >();

        public CreateNodeMenuWindow edgeNodeCreateMenuWindow;
        ...
        public virtual void OnDrop(GraphView graphView, Edge edge)
        {
            ...
            try
            {
                this.graphView.RegisterCompleteObjectUndo("Connected " + edgeView.input.node.title + " and " + edgeView.output.node.title);
