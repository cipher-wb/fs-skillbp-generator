...
{
    public class NpocEventEdgeDragHelper : BaseEdgeDragHelper
    {
        public NpocEventEdgeDragHelper(IEdgeConnectorListener listener):base(listener)
        {
            Reset();
        }
        ...
        protected override EdgeView CreateEdgeView()
        {
            return new EdgeView();
        }
