...
{
	public class NpcEventEdgeConnector : BaseEdgeConnector
    {
		public NpcEventEdgeConnector(IEdgeConnectorListener listener) : base(listener)
		{

        }

        protected override void InitEdgeConnector(IEdgeConnectorListener listener)
        {
            dragHelper = new NpocEventEdgeDragHelper(listener);
