...
namespace GraphProcessor
{
    public class BaseEdgeDragHelper : EdgeDragHelper
    {
        ...
        protected internal const int k_PanAreaWidth = 30;
        protected internal const int k_PanSpeed = 4;
        protected internal const int k_PanInterval = 10;
        protected internal const float k_MinSpeedFactor = 0.5f;
        protected internal const float k_MaxSpeedFactor = 7f;
        protected internal const float k_MaxPanSpeed = k_MaxSpeedFactor * k_PanSpeed;
        protected internal const float kPortDetectionWidth = 30;
        ...
        protected IVisualElementScheduledItem panSchedule;
        protected Vector3 panDiff = Vector3.zero;
        protected bool wasPanned;

        protected bool ResetPositionOnPan { get; set; }
