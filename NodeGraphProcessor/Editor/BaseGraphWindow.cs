...
namespace GraphProcessor
{
	...
	public abstract class BaseGraphWindow : EditorWindow
	{
		...
		public void InitializeGraph(BaseGraph graph,bool isSave = true)
		{
        ...
        /// 主动刷新EditorWindow
        /// </summary>
        public virtual void RefreshWindow(bool reload = true)
        {
            reloadWorkaround = reload;
        }
