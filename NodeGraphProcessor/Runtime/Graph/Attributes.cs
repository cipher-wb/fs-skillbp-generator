...
{
    /// <summary>
    /// 将面板字段根据unity的规则使用UiToolkit绘制在节点上
    /// </summary>
    [AttributeUsage(AttributeTargets.Field, AllowMultiple = false)]
    public class ShowNodeViewAttribute : Attribute
    {
        public Type type;
        public bool IsBindProperty = false;

        public ShowNodeViewAttribute(Type type = null, bool isBindProperty = false)
        {
            this.type = type;
            this.IsBindProperty = isBindProperty;
        }
    }
